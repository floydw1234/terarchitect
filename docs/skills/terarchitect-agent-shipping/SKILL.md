...
- For GitHub-seeded projects whose configured `project_path` is missing, publish can clone `github_url` into `project_path`, then fetch/materialize the AgentHub bundle and verify fast-forward ancestry.
