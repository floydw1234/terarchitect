...
class HippoRAG:
    ...
    def __init__(self,
        ...
        if self.global_config.openie_mode == 'online':
            ...
            raise ValueError(
                "Minimal HippoRAG only supports openie_mode='online'. "
                "Use llm_base_url and embedding_base_url for vLLM and embedding service."
            )
    ...
    def dense_passage_retrieval(self, query: str) -> Tuple[np.ndarray, np.ndarray]:
        ...
        tuple : Tuple[np.ndarray, np.ndarray]
            ...
            - A numpy array of the normalized similarity scores for the corresponding
              documents.
        """
        # No passages indexed: avoid np.dot((0,) or (0,768), (768,)) shape mismatch
    ...
    def graph_search_with_fact_entities(self, query: str,
        ...
        # Avoid divide-by-zero and NaNs when some phrases were never observed.
        # Only normalize entries whose count > 0, leave others at 0.
