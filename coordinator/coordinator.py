...
_COORDINATOR_AGENT_ENV_KEYS = (
    ...
    "DIRECTOR_API_KEY_PATH", "OPENROUTER_API_KEY", "OPENROUTER_API_KEY_PATH",
    "WORKER_MODE", "WORKER_LLM_URL", "WORKER_MODEL", "WORKER_API_KEY", "WORKER_API_KEY_PATH",
    "WORKER_TIMEOUT_SEC", "CODEX_EXTRA_FLAGS", "CODEX_SANDBOX",
    ...
    "OPENAI_API_KEY", "OPENAI_API_KEY_PATH", "openai_api_key",
    "TERARCHITECT_WORKER_API_KEY", "TERARCHITECT_WORKER_API_KEY_PATH",
    "OPENCODE_SERVER_URL", "OPENCODE_SERVER_USERNAME", "OPENCODE_SERVER_PASSWORD",
    "AGENTHUB_URL", "AGENTHUB_API_KEY", "AGENTHUB_API_KEY_PATH", "AGENTHUB_AGENT_ID",
...
_SHIPPER_ENV_KEYS = (
    ...
    "MERGE_TEST_COMMAND",
    "GIT_USER_NAME", "GIT_USER_EMAIL",
    "GH_TOKEN", "GITHUB_TOKEN", "GITHUB_AGENT_TOKEN", "github_agent_token",
)
...
_SECRET_ENV_KEYS = frozenset({
    "TERARCHITECT_WORKER_API_KEY", "TERARCHITECT_WORKER_API_KEY_PATH",
    "GH_TOKEN", "GITHUB_TOKEN", "GITHUB_AGENT_TOKEN", "github_agent_token",
    "AGENT_API_KEY", "WORKER_API_KEY", "WORKER_API_KEY_PATH",
    "OPENAI_API_KEY", "OPENAI_API_KEY_PATH", "openai_api_key", "ANTHROPIC_API_KEY",
    "DIRECTOR_API_KEY", "DIRECTOR_API_KEY_PATH",
    "OPENROUTER_API_KEY", "OPENROUTER_API_KEY_PATH",
    "EMBEDDING_API_KEY", "MEMORY_LLM_API_KEY",
